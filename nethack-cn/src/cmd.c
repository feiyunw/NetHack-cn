...
struct ext_func_tab extcmdlist[] = {
    { "adjust", "调整背包排列字母", doorganize, TRUE },
    { "annotate", "给这一层备注", donamelevel, TRUE },
    { "chat", "和某人交谈", dotalk, TRUE }, /* converse? */
    { "conduct", "列出你的自愿挑战", doconduct,
      TRUE },
    { "dip", "把物品浸到某物", dodip, FALSE },
    { "enhance", "提高或检查武器和魔法技能",
      enhance_weapon_skill, TRUE },
    { "exploremode", "进入探索模式", enter_explore_mode, TRUE },
    { "force", "强行开锁", doforce, FALSE },
    { "invoke", "激活物品的能力", doinvoke, TRUE },
    { "jump", "跳到一个位置", dojump, FALSE },
    { "loot", "搜刮地上的箱子", doloot, FALSE },
    { "monster", "使用怪物的特殊能力", domonability, TRUE },
    { "name", "给怪物或物品命名", docallcmd, TRUE },
    { "offer", "给神献祭", dosacrifice, FALSE },
    { "overview", "显示地牢概述", dooverview, TRUE },
    { "pray", "向神祈祷帮助", dopray, TRUE },
    { "quit", "不保存退出游戏", done2, TRUE },
    { "ride", "乘骑或取消乘骑怪物", doride, FALSE },
    { "rub", "擦拭灯或石头", dorub, FALSE },
    { "sit", "坐下", dosit, FALSE },
    { "terrain", "无障碍显示地图", doterrain, TRUE },
    { "tip", "倒空容器", dotip, FALSE },
    { "turn", "超度", doturn, TRUE },
    { "twoweapon", "拿两把武器战斗", dotwoweapon, FALSE },
    { "untrap", "解除陷阱", dountrap, FALSE },
    { "version", "列出这个NetHack 版本的编译时间选项",
      doextversion, TRUE },
    { "wipe", "擦你的脸", dowipe, FALSE },
...
static const struct ext_func_tab debug_extcmdlist[] = {
    { "levelchange", "改变等级", wiz_level_change, TRUE },
    { "lightsources", "显示移动光源", wiz_light_sources, TRUE },
#ifdef DEBUG_MIGRATING_MONS
    { "migratemons", "migrate n random monsters", wiz_migrate_mons, TRUE },
#endif
    { "monpolycontrol", "控制怪物变形", wiz_mon_polycontrol,
      TRUE },
    { "panic", "测试panic 程序( 制造致命错误)", wiz_panic, TRUE },
    { "polyself", "自我变形", wiz_polyself, TRUE },
#ifdef PORT_DEBUG
    { "portdebug", "wizard port debug command", wiz_port_debug, TRUE },
#endif
    { "seenv", "显示已见向量", wiz_show_seenv, TRUE },
    { "stats", "显示内存统计", wiz_show_stats, TRUE },
    { "timeout", "查看超时队列", wiz_timeout_queue, TRUE },
    { "vanquished", "列出杀死过的怪物", dovanquished, TRUE },
    { "vision", "显示视觉阵列", wiz_show_vision, TRUE },
    { "wizsmell", "嗅探怪物", wiz_smell, TRUE },
#ifdef DEBUG
    { "wizdebug_traveldisplay", "向导调试: 切换移动显示",
      wiz_debug_cmd_traveldisplay, TRUE },
    { "wizdebug_bury", "向导调试: 隐藏你周围的物品",
      wiz_debug_cmd_bury, TRUE },
#endif
    { "wizrumorcheck", "验证谣言边界", wiz_rumor_check, TRUE },
    { "wmode", "显示墙壁模式", wiz_show_wmodes, TRUE },
